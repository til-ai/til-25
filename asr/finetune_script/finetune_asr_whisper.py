...
TEMPO_PERTURB_PROB = 0.25 # Probability to apply tempo perturbation
...
class DataCollatorSpeechSeq2SeqWithPaddingAndNoise:
    ...
    def spec_augment(self, mel_spec, time_mask_param=30, freq_mask_param=13, prob=0.3):
