...
echo til-ai-25-$2 $HOME/$2 gcsfuse ro,allow_other,implicit_dirs,uid=1000,gid=1001,_netdev | sudo tee -a /etc/fstab > /dev/null
echo $1-bucket-til-25 $HOME/$1 gcsfuse rw,allow_other,implicit_dirs,uid=1000,gid=1001,_netdev | sudo tee -a /etc/fstab > /dev/null
...
gcloud config set artifacts/repository $1-repo-til-25
